...
if __name__ == '__main__':
    # 读取图片
    orgimg = cv2.imread('C:/Users/Administrator/Desktop/bishe/images/30.jpg')
...
#疫情高风险地区：呼伦贝尔市（蒙E）；中风险地区：上海浦东新区，上海青浦区（沪），辽宁省大连（辽B），云南瑞丽市（云N）  2021.12.01消息
    ...
    if result4 in list1:
        ...
        volume = 3000  #蜂鸣器3000hz
        time = 3000   #蜂鸣器响3秒
        winsound.Beep(volume,time)
        speaker.Speak('该车牌来自疫情高风险地区，请注意疫情防控')
    elif result4 in list2:
        print("该车牌来自疫情中风险地区，请注意疫情防控")
        volume = 3000  # 蜂鸣器3000hz
        time = 5000  # 蜂鸣器响3秒
        winsound.Beep(volume, time)
        speaker.Speak('该车牌来自疫情中风险地区，请注意疫情防控')
